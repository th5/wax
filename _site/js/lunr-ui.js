$.getJSON("/wax/js/lunr-index.json", function(index_json) {
    ...
    $('input#search').on('keyup', function () {
      ...
      for (var r in results) {
        ...
        var result = '<div class="result"><a href="' + link + '"><img class="sq-thumb-sm" src="/wax/iiif/' + item.collection + '/images/' + item.pid + '-1/full/250,/0/default.jpg"/>&nbsp;&nbsp;&nbsp;<p><span class="title">' + title + '.</span><br>' + meta + '</p></a></div>';
